...
namespace NaradX.Infrastructure.Migrations
{
    ...
    [Migration("20251025172358_WhatsAppTemplate")]
    partial class WhatsAppTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NaradX.Domain.Entities.Template.BodyTextNamedParam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NaradX.Domain.Entities.Template.Example", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NaradX.Domain.Entities.Template.WhatsAppTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("Parameter_Format")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NaradX.Domain.Entities.Template.BodyTextNamedParam", b =>
                {
                    b.HasOne("NaradX.Domain.Entities.Template.Example", null)
                        .WithMany("BodyTextNamedParams")
            ...
            modelBuilder.Entity("NaradX.Domain.Entities.Template.Component", b =>
                {
                    b.HasOne("NaradX.Domain.Entities.Template.Example", "Example")
                        .WithMany()
                        .HasForeignKey("ExampleId");
            ...
            modelBuilder.Entity("NaradX.Domain.Entities.Template.Example", b =>
                {
                    b.Navigation("BodyTextNamedParams");
                });
